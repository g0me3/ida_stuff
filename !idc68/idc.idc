...
success PatchQword      (long ea, long value);   // change a qword (8 bytes)
...
success ExpandStruc(long id, long offset, long delta, long recalc);
...
#define SetType(ea,type) ApplyType(ea, type, TINFO_DEFINITE)
